...
<div class="typrography">
	 <div class="container">
	  <?php
$vid=$_GET['foodid'];   
$ret=mysqli_query($con,"select tblfood.pgName,tblfoodrequests.requestNumber,tblfoodrequests.requestDate,tblfoodrequests.mobileNumber,tblfoodrequests.message,tblfoodrequests.status,tblfoodrequests.donorRemark,tblfoodrequests.requestCompletionDate,tblfoodrequests.fullName,
...
;?></td>
  ...
  <tr>
    ...
    <td><?php echo $row['pgName']; ?></td>
  	<td colspan="2"><button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal">Request Food</button></td>
  </tr>
<?php }  ?>
  </table><?php } ?>
